...
public class MyAccessibilityServiceV2 extends AccessibilityService {
    private static MyAccessibilityServiceV2 instance;
...
//                    Toast.makeText(this, "扫描完毕，请关闭服务后到主界面查看结果", Toast.LENGTH_LONG).show();
    ...
    public static MyAccessibilityServiceV2 getInstance() {
        return MyAccessibilityServiceV2.instance;
    }

    private static void setInstance(MyAccessibilityServiceV2 instance) {
        MyAccessibilityServiceV2.instance = instance;
    }
