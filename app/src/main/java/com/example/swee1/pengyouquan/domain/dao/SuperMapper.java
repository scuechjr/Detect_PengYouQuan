package com.example.swee1.pengyouquan.domain.dao;
 ...
 * @date 2019-08-20
 */
public abstract class SuperMapper extends SQLiteOpenHelper {
    ...
    public SuperMapper(Context context, String dbName) {
